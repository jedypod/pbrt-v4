...
#include <pbrt/geometry/transform.h>
...
void PybindInitGeometry(py::module &m) {
    ...
    py::class_<Bounds2f>(m, "Bounds2f")
        ...
        .def("BoundingSphere", [](const Bounds2f &b) {
                                   Point2f c;
                                   Float r;
    ...
    m.def("InsideExclusive", (bool (*)(const Point2f &, const Bounds2f &))&InsideExclusive);
    ...
    py::class_<Bounds3f>(m, "Bounds3f")
        ...
        .def("SurfaceArea", &Bounds3f::SurfaceArea)
        .def("BoundingSphere", [](const Bounds3f &b) {
                                   Point3f c;
                                   Float r;
                                   b.BoundingSphere(&c, &r);
                                   return std::make_tuple(c, r);
                               })
        .def("IntersectP", (bool (Bounds3f::*)(const Ray &, Float, Float *, Float *) const)&Bounds3f::IntersectP,
             "ray"_a, "tMax"_a = Infinity, "t0"_a = nullptr, "t1"_a = nullptr)
        .def("IntersectP", (bool (Bounds3f::*)(const Ray &, Float, const Vector3f &, const int[3])const)&Bounds3f::IntersectP,
    ...
    m.def("InsideExclusive", (bool (*)(const Point3f &, const Bounds3f &))&InsideExclusive);
    m.def("Expand", (Bounds3f (*)(const Bounds3f &, Float))&Expand);
    m.def("DistanceSquared", (Float (*)(const Point3f &, const Bounds3f &))&DistanceSquared);
    ...
    py::class_<Ray>(m, "Ray")
        ...
        .def(py::init<Point3f, Vector3f, Float, const Medium *>(),
             "o"_a, "d"_a, "time"_a = 0.f, "medium"_a = nullptr)
    ...
    m.def("SameHemisphere", (bool (*)(const Vector3f &, const Vector3f &))&SameHemisphere);
    m.def("SameHemisphere", (bool (*)(const Vector3f &, const Normal3f &))&SameHemisphere);
    ...
    m.def("Union", (DirectionCone (*)(const DirectionCone &, const DirectionCone &))&Union);
    m.def("BoundSubtendedDirections", (DirectionCone (*)(const Bounds3f &, const Point3f &))&BoundSubtendedDirections);

    // splines.h
    m.def("BlossomCubicBezier", [](std::array<Point3f, 4> p, Float u0, Float u1, Float u2) {
                                    return BlossomCubicBezier(MakeConstSpan(p), u0, u1, u2);
                                }, "p"_a, "u0"_a, "u1"_a, "u2"_a);
    m.def("SubdivideCubicBezier", [](std::array<Point3f, 4> p) {
                                      return SubdivideCubicBezier(MakeConstSpan(p));
                                  }, "p"_a);
    m.def("EvaluateCubicBezier", [](std::array<Point3f, 4> cp, Float u) -> std::tuple<Point3f, Vector3f> {
            Vector3f v;
            Point3f p = EvaluateCubicBezier(MakeConstSpan(cp), u, &v);
            return std::make_tuple(p, v);
        }, "cp"_a, "u"_a);
    m.def("CubicBezierControlPoints", [](std::array<Point3f, 4> p, Float uMin, Float uMax) {
                                          return CubicBezierControlPoints(MakeConstSpan(p), uMin, uMax);
                                      }, "p"_a, "uMin"_a, "uMax"_a);
    m.def("BoundCubicBezier", [](std::array<Point3f, 4> p, Float uMin, Float uMax) {
                                  return BoundCubicBezier<Bounds3f>(MakeConstSpan(p), uMin, uMax);
                              }, "p"_a, "uMin"_a, "uMax"_a);
    m.def("ElevateQuadraticBezierToCubic", [](std::array<Point3f, 3> p) {
                                               return ElevateQuadraticBezierToCubic(MakeConstSpan(p));
                                           }, "p"_a);
    m.def("QuadraticBSplineToBezier", [](std::array<Point3f, 3> p) {
                                          return QuadraticBSplineToBezier(MakeConstSpan(p));
                                      }, "p"_a);
    m.def("CubicBSplineToBezier", [](std::array<Point3f, 4> p) {
                                          return CubicBSplineToBezier(MakeConstSpan(p));
                                      }, "p"_a);
    ...
    py::class_<Transform>(m, "Transform")
        ...
        .def("__call__", (Point3f (Transform::*)(const Point3f &) const)&Transform::operator())
        .def("__call__", (Point3f (Transform::*)(const Point3f &, Vector3f *) const)&Transform::operator())
        .def("__call__", (Point3f (Transform::*)(const Point3f &, const Vector3f &, Vector3f *) const)&Transform::operator())
        .def("__call__", (Vector3f (Transform::*)(const Vector3f &) const)&Transform::operator())
        .def("__call__", (Vector3f (Transform::*)(const Vector3f &, Vector3f *) const)&Transform::operator())
        .def("__call__", (Vector3f (Transform::*)(const Vector3f &, const Vector3f &, Vector3f *) const)&Transform::operator())
        .def("__call__", (Normal3f (Transform::*)(const Normal3f &) const)&Transform::operator())
        .def("__call__", (Ray (Transform::*)(const Ray &, Float *) const)&Transform::operator())
        .def("__call__", (Ray (Transform::*)(const Ray &, Vector3f *, Vector3f *) const)&Transform::operator())
        .def("__call__", (Ray (Transform::*)(const Ray &, const Vector3f &, const Vector3f &, Vector3f *, Vector3f *) const)&Transform::operator())
        .def("__call__", (RayDifferential (Transform::*)(const RayDifferential &, Float *) const)&Transform::operator())
        .def("__call__", (Bounds3f (Transform::*)(const Bounds3f &) const)&Transform::operator())
        .def("__call__", (Interaction (Transform::*)(const Interaction &) const)&Transform::operator())
        .def("ApplyInverse", (Point3f (Transform::*)(const Point3f &) const)&Transform::ApplyInverse)
        .def("ApplyInverse", (Vector3f (Transform::*)(const Vector3f &) const)&Transform::ApplyInverse)
        .def("ApplyInverse", (Normal3f (Transform::*)(const Normal3f &) const)&Transform::ApplyInverse)
        .def("ApplyInverse", (Ray (Transform::*)(const Ray &, Float *) const)&Transform::ApplyInverse)
        .def("ApplyInverse", (RayDifferential (Transform::*)(const RayDifferential &, Float *) const)&Transform::ApplyInverse)
        .def("ApplyInverse", (Interaction (Transform::*)(const Interaction &) const)&Transform::ApplyInverse)
        .def(py::self * py::self)
    ...
    py::class_<AnimatedTransform>(m, "AnimatedTransform")
        ...
        .def("__call__", (Ray (AnimatedTransform::*)(const Ray &, Float *) const)&AnimatedTransform::operator())
        .def("__call__", (RayDifferential (AnimatedTransform::*)(const RayDifferential &, Float *) const)&AnimatedTransform::operator())
        .def("__call__", (Point3f (AnimatedTransform::*)(const Point3f &, Float) const)&AnimatedTransform::operator(), "p"_a, "time"_a)
        .def("__call__", (Vector3f (AnimatedTransform::*)(const Vector3f &, Float) const)&AnimatedTransform::operator(), "v"_a, "time"_a)
        .def("__call__", (Interaction (AnimatedTransform::*)(const Interaction &) const)&AnimatedTransform::operator())
        .def("ApplyInverse", (Point3f (AnimatedTransform::*)(const Point3f &, Float) const)&AnimatedTransform::ApplyInverse, "p"_a, "time"_a)
        .def("ApplyInverse", (Vector3f (AnimatedTransform::*)(const Vector3f &, Float) const)&AnimatedTransform::ApplyInverse, "v"_a, "time"_a)
        .def("ApplyInverse", (Interaction (AnimatedTransform::*)(const Interaction &) const)&AnimatedTransform::ApplyInverse)
    ...
    py::class_<Vector2f>(m, "Vector2f")
        ...
        .def("__getitem__", [](const Vector2f &p, int i) { return p[i]; }) // py::is_operator()??
        .def("__setitem__", [](Vector2f &p, int i, Float v) { p[i] = v; })
        .def("__str__", &Vector2f::ToString)
        .def("__repr__",
             [](const Vector2f &p) {
                 return "<pbrt.Vector2f " + p.ToString() + ">";
             })
        ;
    ...
    py::class_<Point2f>(m, "Point2f")
        ...
        .def("__getitem__", [](const Point2f &p, int i) { return p[i]; }) // py::is_operator()??
        .def("__setitem__", [](Point2f &p, int i, Float v) { p[i] = v; })
        .def("__str__", &Point2f::ToString)
        .def("__repr__",
             [](const Point2f &p) {
                 return "<pbrt.Point2f " + p.ToString() + ">";
             })
        ;
    ...
    m.def("DistanceSquared", [](const Point2f &a, const Point2f &b) {
    ...
    py::class_<Point2i>(m, "Point2i")
        ...
        .def("__getitem__", [](const Point2i &p, int i) { return p[i]; }) // py::is_operator()??
        .def("__setitem__", [](Point2i &p, int i, Float v) { p[i] = v; })
        .def("__str__", &Point2i::ToString)
        .def("__repr__",
             [](const Point2i &p) {
                 return "<pbrt.Point2i " + p.ToString() + ">";
             })
        ;
    ...
    m.def("DistanceSquared", [](const Point2i &a, const Point2i &b) {
                                 return DistanceSquared(a, b);
                             });
    ...
    py::class_<Vector3f>(m, "Vector3f")
        ...
        .def("__getitem__", [](const Vector3f &p, int i) { return p[i]; }) // py::is_operator()??
        .def("__setitem__", [](Vector3f &p, int i, Float v) { p[i] = v; })
        .def("__str__", &Vector3f::ToString)
        .def("__repr__",
             [](const Vector3f &p) {
                 return "<pbrt.Vector3f " + p.ToString() + ">";
             })
        ;
    ...
    m.def("AngleBetween", [](const Vector3f &a, const Vector3f &b) {
    ...
    py::class_<Point3f>(m, "Point3f")
        ...
        .def("__getitem__", [](const Point3f &p, int i) { return p[i]; }) // py::is_operator()??
        .def("__setitem__", [](Point3f &p, int i, Float v) { p[i] = v; })
        .def("__str__", &Point3f::ToString)
        .def("__repr__",
             [](const Point3f &p) {
                 return "<pbrt.Point3f " + p.ToString() + ">";
             })
        ;
    ...
    m.def("DistanceSquared", [](const Point3f &a, const Point3f &b) {
                                 return DistanceSquared(a, b);
                             });
    ...
    py::class_<Normal3f>(m, "Normal3f")
        ...
        .def("__getitem__", [](const Normal3f &p, int i) { return p[i]; }) // py::is_operator()??
        .def("__setitem__", [](Normal3f &p, int i, Float v) { p[i] = v; })
        .def("__str__", &Normal3f::ToString)
        .def("__repr__",
             [](const Normal3f &p) {
                 return "<pbrt.Normal3f " + p.ToString() + ">";
             })
        ;
    ...
    m.def("FaceForward", [](const Normal3f &a, const Normal3f &b) { return FaceForward(a, b); });
    m.def("FaceForward", [](const Normal3f &a, const Vector3f &b) { return FaceForward(a, b); });
    m.def("FaceForward", [](const Vector3f &a, const Normal3f &b) { return FaceForward(a, b); });
    m.def("FaceForward", [](const Vector3f &a, const Vector3f &b) { return FaceForward(a, b); });
