...
void PybindInitSamplingSobol(py::module &m) {
    m.def("SobolIntervalToIndex", &SobolIntervalToIndex, "log2Resolution"_a,
          "sampleNum"_a, "p"_a);
    m.def(
        "SobolSampleFloat",
    ...
    m.def(
        ...
        "index"_a, "dimension"_a, "randomizer"_a);
    m.def("SobolSampleBits32", &SobolSampleBits32, "a"_a, "dimension"_a);
    m.def("SobolSampleBits64", &SobolSampleBits64, "a"_a, "dimension"_a);
}
