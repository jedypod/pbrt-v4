...
void PybindInitUtil(py::module &m) {
    ...
    m.def("NextFloatDown", (double (*)(double, int))(&NextFloatDown), "v"_a, "delta"_a = 1);
    ...
    m.def("HashBuffer", (uint64_t (*)(const void *, size_t))(&HashBuffer),
          "ptr"_a, "size"_a);

    // interpolation.h
    m.def("CatmullRom", [](std::vector<Float> nodes, std::vector<Float> values,
                           Float x) {
                            return CatmullRom(nodes, values, x);
                        }, "nodes"_a, "values"_a, "x"_a);
    m.def("CatmullRomWeights", [](std::vector<Float> nodes, Float x) {
    ...
    m.def("Bilerp", [](std::array<Float, 2> p, std::array<Float, 4> v) { return Bilerp(p, v); });
    ...
    m.def("EvaluatePolynomial", [](Float t, Float a) { return EvaluatePolynomial(t, a); });
    m.def("EvaluatePolynomial", [](Float t, Float a, Float b) { return EvaluatePolynomial(t, a, b); });
    m.def("EvaluatePolynomial", [](Float t, Float a, Float b, Float c) { return EvaluatePolynomial(t, a, b, c); });
    ...
    m.def("EvaluatePolynomial", [](Float t, Float a, Float b, Float c, Float d, Float e, Float f) {
                                    return EvaluatePolynomial(t, a, b, c, d, e, f);
                                });
    m.def("EvaluatePolynomial", [](Float t, Float a, Float b, Float c, Float d, Float e, Float f, Float g) {
                                    return EvaluatePolynomial(t, a, b, c, d, e, f, g);
                                });

    m.def("FindInterval", [](size_t size, std::function<Float(int)> pred) { return FindInterval(size, pred); });

    m.def("NewtonBisection", [](Float x0, Float x1, std::function<std::pair<Float, Float>(Float)> f, Float xEps,
                                Float fEps) -> Float {
                                 return NewtonBisection(x0, x1, f, xEps, fEps);
    ...
    py::class_<SquareMatrix<2>>(m, "SquareMatrix2")
        ...
        .def("Diag", [](std::array<Float, 2> v) { return SquareMatrix<2>::Diag(v[0], v[1]); })
        .def("IsIdentity", &SquareMatrix<2>::IsIdentity)
        .def("__eq__", [](const SquareMatrix<2> &a, const SquareMatrix<2> &b) { return a == b; })
        .def("__str__", &SquareMatrix<2>::ToString)
        .def("__getitem__", [](const SquareMatrix<2> &m, std::array<int, 2> index) {
                                return m[index[0]][index[1]];
                            })
        .def("__setitem__", [](SquareMatrix<2> &m, std::array<int, 2> index,
                               double v) {
                                m[index[0]][index[1]] = v;
                            });
    ...
    py::class_<SquareMatrix<3>>(m, "SquareMatrix3")
        ...
        .def("Diag", [](std::array<Float, 3> v) { return SquareMatrix<3>::Diag(v[0], v[1], v[2]); })
        .def("__eq__", [](const SquareMatrix<3> &a, const SquareMatrix<3> &b) { return a == b; })
        .def("IsIdentity", &SquareMatrix<3>::IsIdentity)
        .def("__str__", &SquareMatrix<3>::ToString)
        .def("__getitem__", [](const SquareMatrix<3> &m, std::array<int, 3> index) {
                                return m[index[0]][index[1]];
                            })
        .def("__setitem__", [](SquareMatrix<3> &m, std::array<int, 3> index,
                               double v) {
                                m[index[0]][index[1]] = v;
                            });
    ...
    py::class_<SquareMatrix<4>>(m, "SquareMatrix4")
        ...
        .def("Diag", [](std::array<Float, 4> v) { return SquareMatrix<4>::Diag(v[0], v[1], v[2], v[3]); })
        .def("IsIdentity", &SquareMatrix<4>::IsIdentity)
        .def("__eq__", [](const SquareMatrix<4> &a, const SquareMatrix<4> &b) { return a == b; })
        .def("__str__", &SquareMatrix<4>::ToString)
        .def("__getitem__", [](const SquareMatrix<4> &m, std::array<int, 4> index) {
                                return m[index[0]][index[1]];
                            })
        .def("__setitem__", [](SquareMatrix<4> &m, std::array<int, 4> index,
                               double v) {
                                m[index[0]][index[1]] = v;
                            });
    ...
    // print.h
    m.def("FloatToString", [](float v) { return FloatToString(v); }, "v"_a);
    m.def("DoubleToString", [](double v) { return DoubleToString(v); }, "v"_a);
    ...
    m.def("PermutationElement", &PermutationElement,
          "Return i'th element of a permutation of length |l|",
          "i"_a, "l"_a, "hash"_a);
}
