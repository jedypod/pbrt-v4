...
void PybindInitShapes(py::module &m) {
    py::class_<Cone, TransformedShape>(m, "Cone")
        .def(py::init<const Transform *, const Transform *, bool, Float, Float, Float,
             const std::shared_ptr<const ParameterDictionary> &>(),
             "worldFromObject"_a, "objectFromWorld"_a, "reverseOrientation"_a = false, "height"_a = 1,
             "radius"_a = 1, "phiMax"_a = 2 * Pi, "attributes"_a = nullptr);

    py::class_<Curve, Shape>(m, "Curve")
        .def(py::init<const CurveCommon *, Float, Float>(),
             "common"_a, "uMin"_a = 0, "uMax"_a = 1);
        ...
        .def(py::init([](std::array<Point3f, 4> cp, Float w0, Float w1, CurveType type,
                         ...
                         const std::shared_ptr<const ParameterDictionary> &attributes) {
                          return CurveCommon(MakeConstSpan(cp), w0, w1, type, MakeConstSpan(norm),
                                             worldFromObject, objectFromWorld, reverseOrientation, attributes);
                      }));
    ...
    py::class_<Cylinder, TransformedShape>(m, "Cylinder")
        .def(py::init<const Transform *, const Transform *, bool, Float, Float, Float,
             ...
             "worldFromObject"_a, "objectFromWorld"_a, "reverseOrientation"_a = false, "radius"_a = 1,
             "zMin"_a = 0, "zMax"_a = 1, "phiMax"_a = 2 * Pi, "attributes"_a = nullptr);

    py::class_<Disk, TransformedShape>(m, "Disk")
        .def(py::init<const Transform *, const Transform *, bool, Float, Float, Float,
             Float, const std::shared_ptr<const ParameterDictionary> &>(),
             "worldFromObject"_a, "objectFromWorld"_a, "reverseOrientation"_a = false, "height"_a = 1,
             "radius"_a = 1, "innerRadius"_a = 0, "phiMax"_a = 2 * Pi, "attributes"_a = nullptr);

    py::class_<Hyperboloid, TransformedShape>(m, "Hyperboloid")
        .def(py::init<const Transform *, const Transform *, bool, const Point3f &, const Point3f &,
             Float, const std::shared_ptr<const ParameterDictionary> &>(),
             "worldFromObject"_a, "objectFromWorld"_a, "reverseOrientation"_a = false, "p1"_a = Point3f(0, 0, 0),
             "p2"_a = Point3f(1, 1, 1), "phiMax"_a = 2 * Pi, "attributes"_a = nullptr);

    py::class_<Paraboloid, TransformedShape>(m, "Paraboloid")
        .def(py::init<const Transform *, const Transform *, bool, Float, Float, Float,
             Float, const std::shared_ptr<const ParameterDictionary> &>(),
             "worldFromObject"_a, "objectFromWorld"_a, "reverseOrientation"_a = false, "radius"_a = 1,
             "z0"_a = 0, "z1"_a = 1, "phiMax"_a = 2 * Pi, "attributes"_a = nullptr);
    ...
    m.def("CreateLoopSubdiv", CreateLoopSubdiv,
          "worldFromObject"_a, "reverseOrientation"_a = false, "params"_a, "attributes"_a, "arena"_a);
    m.def("CreateNURBS", CreateNURBS,
          "worldFromObject"_a, "reverseOrientation"_a = false, "params"_a, "attributes"_a, "arena"_a);
    m.def("CreatePLYMesh", CreatePLYMesh,
          "worldFromObject"_a, "reverseOrientation"_a = false, "params"_a, "attributes"_a, "arena"_a);

    py::class_<Triangle>(m, "Triangle")
        .def(py::init<int, int>(), "meshIndex"_a, "triIndex"_a)
        .def("WorldBound", &Triangle::WorldBound)
        .def("Intersect", &Triangle::Intersect)
        .def("IntersectP", &Triangle::IntersectP)
        .def("Area", &Triangle::Area)
        .def("Sample", (Optional<ShapeSample> (Triangle::*)(const Interaction &, const Point2f &) const)&Triangle::Sample)
        .def("Sample", (Optional<ShapeSample> (Triangle::*)(const Point2f &) const)&Triangle::Sample)
        .def("Pdf", (Float (Triangle::*)(const Interaction &, const Vector3f &) const)&Triangle::Pdf)
