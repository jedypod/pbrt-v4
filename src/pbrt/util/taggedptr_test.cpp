...
struct Handle : public TaggedPointer<IntType<0>, IntType<1>, IntType<2>,
                                     IntType<3>, IntType<4>, IntType<5>,
                                     IntType<6>, IntType<7>, IntType<8>,
                                     IntType<9>, IntType<10>, IntType<11>,
                                     IntType<12>, IntType<13>, IntType<14>> {
    using TaggedPointer::TaggedPointer;

    int func() {
        auto f = [&](auto ptr) { return ptr->func(); };
        return ApplyCPU<int>(f);
    }
    int cfunc() const {
